...
export default function AdminLayout() {
  ...
  const tabs = [
    { name: 'students', label: 'Students', icon: '👨‍🎓', path: '/(admin)/students' },
    { name: 'staff', label: 'Staff', icon: '👨‍💼', path: '/(admin)/staff' },
    { name: 'approvals', label: 'Approvals', icon: '✓', path: '/(admin)/approvals' },
    { name: 'my-card', label: 'My Card', path: '/(admin)/my-card' },
  ];
        ...
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerLeft}>
            <View style={[styles.logoBadge, { backgroundColor: colors.primary }]}>
              <ThemedText style={styles.logoText}>TU</ThemedText>
            </View>
            <View>
