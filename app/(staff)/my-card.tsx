      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.profileSection}>
          <View style={[styles.avatarContainer, { backgroundColor: colors.secondary }]}>
            <ThemedText style={styles.avatarText}>SF</ThemedText>
          </View>
          <ThemedText style={styles.profileName}>Staff Member</ThemedText>
          <ThemedText style={styles.profileEmail}>staff@university.edu</ThemedText>
        </View>
        ...
        <View style={[styles.cardContainer, { 
          ...
          <View style={[styles.card, { 
            ...
            <View style={styles.cardBody}>
              <ThemedText style={styles.cardLabel}>Staff Member</ThemedText>
              <ThemedText style={styles.cardName}>Staff Member</ThemedText>
              <ThemedText style={styles.cardNumber}>ID: SF001</ThemedText>
            </View>
        ...
        <View style={styles.infoSection}>
          <View style={[styles.infoCard, { 
            ...
            <ThemedText style={styles.infoValue}>Staff Member</ThemedText>
          </View>
        ...
        <View style={[styles.accessCard, { 
          ...
          <View style={styles.accessHeader}>
            ...
            <View style={styles.accessInfo}>
              ...
              <ThemedText style={styles.accessSubtitle}>Card is active</ThemedText>
            </View>
          </View>
        ...
        <View style={[styles.detailsCard, { 
          ...
          <View style={styles.detailRow}>
            ...
            <ThemedText style={styles.detailValue}>Department Staff</ThemedText>
          </View>
          <View style={styles.detailRow}>
