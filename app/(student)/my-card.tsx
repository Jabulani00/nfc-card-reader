      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.profileSection}>
          {card.hasProfileImage() ? (
            ...
            <View style={[styles.avatarContainer, { backgroundColor: colors.info }]}>
              <ThemedText style={styles.avatarText}>{card.getInitials('ST')}</ThemedText>
            </View>
          )}
        ...
        <View style={[styles.cardContainer, { 
          ...
          <View style={[styles.card, { 
            ...
            <View style={styles.cardHeader}>
              <ThemedText style={[styles.roleTitle, { color: colors.info }]}>STUDENT</ThemedText>
              <View style={[styles.headerLine, { backgroundColor: colors.info }]} />
            </View>
            ...
            <View style={styles.cardBody}>
              ...
              <View style={styles.leftSide}>
                <View style={styles.decorativeElements}>
                  <View style={[styles.diamond, styles.diamond1, { backgroundColor: colors.info }]} />
              ...
              <View style={styles.centerSection}>
                <View style={styles.userInfoSection}>
                  <ThemedText style={[styles.userName, { color: colors.info }]}>
              ...
              <View style={styles.rightSide}>
                {card.hasProfileImage() ? (
                  ...
                  <View style={[styles.profilePlaceholder, { backgroundColor: colors.backgroundSecondary }]}>
                    <ThemedText style={[styles.profileInitials, { color: colors.info }]}>
                      {card.getInitials('ST')}
                    </ThemedText>
                  </View>
                )}
        ...
        <View style={styles.infoSection}>
          <View style={[styles.infoCard, { 
            ...
            <ThemedText style={styles.infoValue}>{card.getRoleDisplayName('student')}</ThemedText>
          </View>
