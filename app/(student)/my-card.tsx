...
export default function StudentMyCardScreen() {
  ...
  if (!card.isReady) {
    return <UserCardLoading color={colors.info} />;
  }
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.gradientOverlay}>
        <View style={[styles.circle, styles.circle1, { backgroundColor: '#00C8FC', opacity: isDark ? 0.06 : 0.10 }]} />
        <View style={[styles.circle, styles.circle2, { backgroundColor: '#00C8FC', opacity: isDark ? 0.06 : 0.10 }]} />
        <View style={[styles.circle, styles.circle3, { backgroundColor: '#00C8FC', opacity: isDark ? 0.04 : 0.08 }]} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.virtualCardSection}>
          <View style={styles.cardHeader}>
            <ThemedText style={styles.cardHeaderTitle}>Student ID Card</ThemedText>
            <ThemedText style={styles.cardHeaderSubtitle}>Virtual Access Card</ThemedText>
          </View>
            ...
            >
              ...
              <View style={[styles.bankCardContent, isCardVisible && styles.portraitCardContent]}>
                ...
                <View style={styles.cardTopRow}>
                  <ThemedText style={styles.cardType}>STUDENT ID</ThemedText>
                  {isCardVisible ? (
                ...
                <View style={styles.cardNumberSection}>
                  ...
                  <ThemedText style={[styles.cardNumber, !isCardVisible && styles.blurredText, isCardVisible && styles.portraitText]}>
                ...
                <View style={[styles.cardDetailsRow, isCardVisible && styles.portraitDetailsRow]}>
                  <View style={styles.cardDetailItem}>
                    ...
                    <ThemedText style={[styles.cardValue, !isCardVisible && styles.blurredText, isCardVisible && styles.portraitText]}>
                      {isCardVisible ? `${user!.firstName} ${user!.lastName}` : '•••••••••'}
                    </ThemedText>
                  </View>
                  <View style={styles.cardDetailItem}>
          ...
          <>
            ...
            <View style={[styles.infoSection, isCardVisible && styles.portraitSpacing]}>
              <View style={[styles.infoCard, { 
                backgroundColor: isDark ? 'rgba(0, 200, 252, 0.08)' : 'rgba(0, 200, 252, 0.05)',
                ...
                <ThemedText style={[styles.infoValue, { color: '#00C8FC' }]}>{card.getRoleDisplayName('student')}</ThemedText>
              </View>
              ...
              <View style={[styles.infoCard, { 
                ...
                <ThemedText style={[styles.infoValue, { color: '#00C8FC' }]}>{user!.department}</ThemedText>
              </View>
            </View>

        {/* Elegant Access Status Card */}
        <View style={[styles.accessCard, { 
          backgroundColor: isDark ? 'rgba(52, 199, 89, 0.1)' : 'rgba(52, 199, 89, 0.05)',
          ...
          <View style={styles.accessHeader}>
            ...
            <View style={styles.accessInfo}>
              ...
              <ThemedText style={styles.accessSubtitle}>
                {card.getAccessStatusText('student')}
              </ThemedText>
            </View>
          </View>
        ...
        <View style={[styles.detailsCard, { 
          ...
          <View style={[styles.detailRow, { borderBottomColor: isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)' }]}>
            ...
            <ThemedText style={[styles.detailValue, { color: '#00C8FC' }]}>{user!.cardNumber}</ThemedText>
          </View>
          <View style={[styles.detailRow, { borderBottomColor: isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)' }]}>
          ...
          <View style={[styles.detailRow, { borderBottomWidth: 0 }]}>
            ...
            <View style={[styles.statusBadge, { 
              backgroundColor: card.shouldShowSuccess() ? '#34C759' : card.shouldShowWarning() ? colors.warning : colors.error 
            }]}>
            ...
            <View style={[styles.infoBox, { 
              backgroundColor: isDark ? 'rgba(0, 200, 252, 0.12)' : 'rgba(0, 200, 252, 0.08)',
              ...
              <View style={styles.infoBoxContent}>
                <ThemedText style={[styles.infoBoxTitle, { color: '#00C8FC' }]}>How to Use Your Card</ThemedText>
                <ThemedText style={styles.infoBoxText}>
                  Present this digital card at NFC readers around campus for building access, library services, and meal plans. Your card is encrypted and secure.
                </ThemedText>
              </View>
            </View>
          </>
